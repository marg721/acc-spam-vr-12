...
/////////////////// tanha bnusa jano 1k hata 10k haya //////////////// spam bashe yakam
jano.on("message", message => {
  if (message.content === "jano 1k") {
    let count = 0;
    let ecount = 0;
...
jano.on("message", async message => {
  if (message.content === "stop") {
    ...
    await message.channel.send("ay xore lo spammm pe akay madam");
  }
});
////////////////////////
...
//////////////////// bashe seyam kota spama 

////////////////////
jano.on("message", message => {
  if (message.content === "just") {
    let letters = "ajhcbxwgfcbsljdvvvvvvvvvvvvvvvvvvvahocbrqeuooowuqytqqwertyuioplkjhgfddsazxcvbnm1234567890".split(
      ""
    );
...
/////////////
jano.on("ready", () => {
    var join = jano.channels.get("841325619610779709"); ///////////////// id voice 
    if (join) join.join();
  });
/////////////////
jano2.on("ready", () => {
